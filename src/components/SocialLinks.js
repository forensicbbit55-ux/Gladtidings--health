...
export default function SocialLinks({ className = '', showLabels = true }) {
  const socialLinks = [
    {
      name: ';Facebook',
      url: 'https://www.facebook.com/gladtidings',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/gladtidings',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      url: 'https://www.youtube.com/@gladtidings',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505a3.017 3.017 0 0 0-2.122 2.136C.282 9.223 0 12 0 12s.282 2.777.501 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.377.505 9.377.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24.282 14.777 24 12 24 12s-.282-2.777-.501-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
        </svg>
      ),
    ...
    <div className={`flex items-center space-x-3 ${className}`}>
      {socialLinks.map((social) => (
        <a
          ...
          className={`flex items-center px-3 py-2 text-white rounded-lg transition-all duration-200 transform hover:scale-105 ${social.color}`}

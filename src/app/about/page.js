  ...
  const slides = [
    {
      ...
      description: 'Bringing healthcare and hope to underserved communities worldwide through natural remedies and compassionate care'
    },
    {
      ...
      description: 'Dedicated healthcare professionals committed to your wellness journey with natural solutions'
    },
    {
      ...
      description: 'Sourcing the finest organic ingredients and natural remedies for optimal health'
    },
    {
      ...
      description: 'Integrating faith-based care with natural health solutions for complete wellness'
    }
  ]
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Glad Tidings was founded with a mission to bring healing and hope to communities through the power of natural remedies and the love of Christ. We believe that true wellness encompasses both physical health and spiritual well-being.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                For over two decades, we have been dedicated to providing high-quality organic products, natural health solutions, and compassionate care to those seeking alternatives to conventional medicine. Our approach combines time-tested natural remedies with modern scientific understanding.
              </p>
              
              <h2 className="text-2xl font-bold text-gray-900 mb-6 mt-8">Our Values</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">We source only the finest organic ingredients and maintain strict quality standards</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600 text-sm">We care deeply about our customers and their journey to wellness</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600 text-sm">We operate with honesty and transparency in all we do</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Meet the dedicated professionals behind Glad Tidings</p>
          </div>

...
const wellnessProducts = [
  {
    ...
    price: 3500,
    description: 'Pure therapeutic grade lavender oil for relaxation and better sleep',
  ...
  },
  {
    ...
    name: 'Tea Tree Oil',
    price: 3200,
    description: 'Antiseptic tea tree oil for skin care and immune support',
  ...
  },
  {
    ...
    name: 'Peppermint Oil',
    price: 2500,
    description: 'Cooling peppermint oil for digestion and headache relief',
  ...
  },
  {
    ...
    name: 'Lemon Oil',
    price: 2200,
    description: 'Uplifting lemon oil for mood enhancement and natural cleaning',
    image: '/images/products/lemon-oil.jpg',
    rating: 4.7,
    reviews: 145,
    featured: false
  },
  {
    ...
    price: 4500,
    description: 'Premium frankincense oil for meditation and skin rejuvenation',
    image: '/images/products/frankincense-oil.jpg',
    rating: 4.9,
    reviews: 67,
    featured: true
  }
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">Wellness Products</h1>
            <p className="text-xl mb-8 text-emerald-100">
              Essential oils and aromatherapy products for holistic wellness
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
                    <span className="text-sm text-gray-600">Carrier Oils</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
                    <span className="text-sm text-gray-600">Diffusers</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
                    <span className="text-sm text-gray-600">Roller Bottles</span>
                  </label>
                </div>
              </div>

              <div className="mb-6">
                <h4 className="font-medium text-gray-700 mb-3">Use</h4>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center mb-6">
              <p className="text-gray-600">Showing {wellnessProducts.length} products</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {wellnessProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="p-4">
                    <div className="mb-2">
                      <span className="text-xs text-emerald-600 font-medium">Wellness Product</span>
                    </div>

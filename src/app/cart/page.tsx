          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="space-y-4">
                {items.map((item) => (
                  <div key={item.id} className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 pb-4 border-b last:border-b-0">
                    {/* Product Image */}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-8">
              ...
              <div className="mt-6 p-4 bg-emerald-50 rounded-lg">
                <h3 className="font-semibold text-emerald-800 mb-2">Secure Checkout</h3>
                <p className="text-sm text-emerald-600">
                  Your payment information is encrypted and secure. We accept M-Pesa for all transactions.
                </p>
              </div>
            </div>
          </div>

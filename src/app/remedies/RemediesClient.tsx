...
export default function RemediesClient({ remedies }: RemediesClientProps) {
  const { addToCart, isInCart } = useCartStore()

  const handleAddToCart = (remedy: Remedy) => {
    addToCart({
